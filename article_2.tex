...
\begin{abstract}
  Les vingt dernières années ont vu une augmentation exponentielle de la puissance de calcul des ordinateur personnels,
  ...
  constituent à ce jour l'état de l'art. D'un autre côté, on a aussi eu une progression importante de l'Internet Des Objet, cela 
  a créé le besoin de reseaux de neurones adaptés aux objet peut puissant. L'objectif de ce papier est de présenter les différentes 
