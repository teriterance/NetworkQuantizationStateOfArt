...
\title{State of Art of Artificial Neurals Networks Compression} % Article title
\author{%
...
\begin{abstract}
  ...
  On the last twenty year, we had an exponential raising of personnal computer compute capacities.
